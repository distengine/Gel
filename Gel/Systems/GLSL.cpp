...
const std::string gel::GLSL::getShaderNameFromEnum(const GLenum & shaderType)
{
...
void gel::GLSL::addShader(GLenum shaderType, const std::string fileName)
{
